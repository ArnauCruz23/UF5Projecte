...
public class ERxerciciMain{
    ...
    public static void main(String[] args) {
       ...
       candidatos.add(new Persona(5, Sexo.HOMBRE, 40, true, OrientacionSexual.BISEXUAL, Formacion.GRADO_SUPERIOR, OrientacionPolitica.EXTREMA_IZQUIERDA));
       candidatos.add(new Persona(6, Sexo.MUJER, 54, true, OrientacionSexual.HETERO, Formacion.GRADO_SUPERIOR, OrientacionPolitica.EXTREMA_DERECHA));
       candidatos.add(new Persona(7, Sexo.MUJER, 24, true, OrientacionSexual.HETERO, Formacion.GRADO_SUPERIOR, OrientacionPolitica.EXTREMA_DERECHA));
       
       Persona aux = new Persona(99, Sexo.HOMBRE, 24, true, OrientacionSexual.HETERO, Formacion.GRADO_SUPERIOR, OrientacionPolitica.EXTREMA_DERECHA);      
